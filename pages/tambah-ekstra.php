...
<body class="g-sidenav-show  bg-gray-200">
  <aside
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-info" href="../pages/tambah-ekstra.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Tambah Ekstra</li>
          </ol>
        </nav>
    ...
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <div class="card">
          ...
          <div class="card-body">
          <form id="formTambahEkstra" action="javascript:void(0);" method="post">
            <div class="form-group">
              <label for="namaEkstra">Nama Ekstra:</label>
              <input type="text" class="form-control" id="namaEkstra" name="namaEkstra" style="background-color: #f0f0f0; padding: 10px; border-radius: 10px; margin-bottom: 20px;" placeholder="Masukkan nama ekstra" required>
            </div>
            <div class="form-group">
              <label for="hari">Hari:</label>
              <select class="form-control" id="hari" name="hari" style="background-color: #f0f0f0; padding: 10px; border-radius: 10px; margin-bottom: 20px;" required>
                <option>...</option>
  ...
  <script>
document.getElementById('formTambahEkstra').addEventListener('submit', function(event) {
  event.preventDefault(); // Menghentikan form dari submit biasa

  var formData = new FormData(this);

  fetch('../assets/config/tambah-ekstra.php', {
    method: 'POST',
    body: formData
  })
